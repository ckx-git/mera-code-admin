    ...
    <div class="section-container">
      ...
      <div class="filter-container">
        <div class="filter-items">
          ...
          <el-button type="info" size="small" @click="toExamResultsPage">成绩总览</el-button>
          <el-button size="small" @click="toExamResultPage(1)">#1 题</el-button>
          <el-button size="small" @click="toExamResultPage(2)">#2 题</el-button>
        </div>
        <!-- <div class="filter-items">
      ...
      >
        ...
        <el-table-column prop="time" label="代码" header-align="center" align="center">
          <template #default>
            <div style="cursor: pointer;" @click="viewCodeDetail">
              查看代码
            </div>
          </template>
        </el-table-column>
